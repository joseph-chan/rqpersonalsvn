...
class WordNetIndexor
{
	...
	int LoadIndexmmap(const char* word_index,const char* term_info,const char * relate_info,__gnu_cxx::hash_map<u_int,u_int> & TermIndex, vector<term_info_t> &TermInfo,file_mmap_t *file_mmap,total_index_info_t *total_info);
