...
*/
TransSrvControl_t *TransSrvCreate(unsigned short iServerNum, unsigned short iPort, DO_ONE_DOC *doOneDoc, CREATE_WORKING_DATA *createData, RELEASE_WORKING_DATA *releaseData);
